...
public class HttpRequest {
	...
	public HttpRequest setHead(String key,String val){
		if(key != null)requestHeaders.put(key, val);
		return this;	
	}
	
	public HttpRequest setParam(String key,String val){
		if(key != null)parameters.put(key, val);
		return this;
	}
